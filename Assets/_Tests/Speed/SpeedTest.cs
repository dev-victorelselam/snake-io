    ...
    public class SpeedTest : AssertMonoBehaviour
    {
        public void Awake()
        {
            ...
            Assert(() => speedMock1 > speedMock2)
                .ShouldBe(true).Because($"Speed Mock 1 has 1 less load").Run();
            ...
            Assert(() => speedMock3 > speedMock4)
                .ShouldBe(true).Because($"Speed Mock 3 has 1 more speed block").Run();
            ...
            Assert(() => speedMock5 > speedMock6)
                .ShouldBe(true).Because($"Speed Mock 5 has 1 more speed block, and it should compensate 1 more load").Run();
